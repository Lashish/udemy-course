...
function CitiesProvider({ children }) {
    ...
    useEffect(function () {
        async function fetchCities() {
            ...
            try {
                ...
                dispatch({ type: "rejected", error: "There was an error loading data..." })
            }
        }
        fetchCities();
    }, []);
    ...
    async function getCity(id) {
        ...
        try {
            ...
            dispatch({ type: "rejected", payload: "There is an Error loaing city" })
        }
    }
    async function createCity(newCity) {
        ...
        try {
            ...
            dispatch({ type: "rejected", payload: "There is an Error creating city" })
        }
    }
...
function useCities() {
    ...
    if (context === undefined) throw new Error("Cities context was used outside of the CityList components");
    return context;
}
